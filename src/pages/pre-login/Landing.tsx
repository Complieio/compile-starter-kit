...
export default function CompliePage(): JSX.Element {
  ...
  return (
    <div>
      <style>{`:root{--accent-a:#1a1a1a;--accent-b:#374151;--accent-grad:linear-gradient(90deg,var(--accent-a),var(--accent-b));--surface:#ffffff;--muted:#f5f5f5;--text:#1a1a1a;--muted-border:#e6e6e6}
