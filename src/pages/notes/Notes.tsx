...
const NOTE_TEMPLATES: NoteTemplate[] = [
  ...
  },
  {
    ...
    color: 'bg-blue-50 border-blue-200 text-blue-700',
    category: 'freelancer',
    content: '<h1>[Project Title]</h1><p>[Client / Company Name]<br>[Date]</p><p><br></p><p>This brief outlines the key information for the upcoming graphic design project. The purpose of the project is to [describe overall objective or goal, e.g., create a new visual identity, design marketing materials, refresh digital assets]. The design work should align with [client\\\'s brand values, tone, or positioning] and be suitable for use across [channels, platforms, or formats].</p><p><br></p><p>The scope of work includes [list deliverables such as logo, social media graphics, print materials, web assets, packaging, etc.]. All designs are expected to follow [brand guidelines, color schemes, typography preferences, or if none exist, note that creative direction will be developed].</p><p><br></p><p>The intended audience is [target demographic or user group], and the design should communicate [key messages, emotions, or qualities the client wants to convey]. Specific requirements, such as preferred styles, formats, or dimensions, should be noted here: [details].</p><p><br></p><p>The project timeline is [insert timeframe, including deadlines, milestones, or review points]. Budget and resources are [details of budget range, licensing considerations, or materials if applicable].</p><p><br></p><p>Final deliverables will be provided in [required file formats] and prepared for [print, digital, or multi-platform use as needed]. Feedback and approval will be coordinated through [point of contact or review process].</p><p><br></p><p>Prepared by: [Your Name / Business]<br>[Role / Contact Information]</p>'
  },
  {
    id: 'business-plan',
